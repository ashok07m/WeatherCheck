...
import com.weather.di.component.DaggerActivityComponent;
import com.weather.di.module.ActivityModule;
import com.weather.utils.NetworkUtils;
import com.weather.utils.ViewUtils;
...
public abstract class BaseActivity extends AppCompatActivity implements IBaseView {
    ...
    public void onError(String message) {
        if (message != null) {
            ...
            showSnackBar(getString(R.string.some_error_occurred));
        }
    }
